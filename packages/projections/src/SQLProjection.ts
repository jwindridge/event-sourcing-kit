...
import { IEventStore, TYPES as EventStoreTypes } from '@eskit/eventstore';

import { TYPES } from './constants';
import { buildTable, eventEmitterAsyncIterator } from './util';
...
abstract class SQLProjection implements IProjection {
  ...
  constructor(
    @inject(TYPES.KnexClient) knex: Knex,
    @inject(EventStoreTypes.EventStore) store: IEventStore,
    @inject(TYPES.ProjectionPositionStore)
